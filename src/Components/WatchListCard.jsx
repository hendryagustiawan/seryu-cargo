...
export default function WatchListCard({ handleRemoveFromWatchlist, id, image, title, years }) {
      ...
      <div className="p-2">
        <div className="card" style={{ width: "15rem", backgroundColor: "#050E12" }}>
          <div className="position-relative">
            ...
            <i onClick={() => handleRemoveFromWatchlist(id)} className="fa-regular fa-bookmark position-absolute fa-xl" style={{ bottom: 30, left: 200, cursor: "pointer", color: "#ffff" }}></i>
          </div>
